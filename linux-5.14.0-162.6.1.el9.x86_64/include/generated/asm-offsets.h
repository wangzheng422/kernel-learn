...
#define TASK_threadsp 6104 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 2696 /* offsetof(struct task_struct, stack_canary) */
...
#define VMX_spec_ctrl 8736 /* offsetof(struct vcpu_vmx, spec_ctrl) */
